...
static struct module_pin_mux gpio1_21_pin_mux[] = {
	{OFFSET(gpmc_a5), MODE(7) | PULLUDEN},                  /* GPIO1_21, LCD Backlight */
	{-1},
};

static struct module_pin_mux gpio3_7_pin_mux[] = {
	{OFFSET(emu0), MODE(7) | PULLUDEN},                     /* GPIO3_7, Buzzer */
	{-1},
};
...
void enable_board_pin_mux(void)
{
	...
	configure_module_pin_mux(gpio1_21_pin_mux);
